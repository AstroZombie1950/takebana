...
const EN = {
    ...
    'Активный стрим не найден.': 'No active stream found.',
    ...
    'У вас уже есть активный стрим.': 'You already have an active stream.',
    'Трансляция запущена': 'Stream started',
    ...
    'Стрим успешно поставлен на паузу.': 'Stream paused.',
